...
(** [use fmt content] Execute commands [content]. It does not print types
    nor values. *)
val use : formatter -> string -> bool

(** [execute print fmt content] Execute [content]. [print] says whether the
    values and types of the results should be printed. [pp_code] formatter
    can be use to output ocaml source during lexing. *)
val execute :
     bool
  -> ?pp_code:formatter
