...
;; test 7 eq_int
     (compare_big_int (big_int_of_int (-1)) (big_int_of_int (-1)), 0)

;; test 8 eq_int
     (compare_big_int (big_int_of_int 1) (big_int_of_int (-1)), 1)
...
;; test 12 eq_int
     (compare_big_int (big_int_of_int (-1)) (big_int_of_int (-2)), 1)

;; test 13 eq_int
     (compare_big_int (big_int_of_int (-2)) (big_int_of_int (-1)), -1)
...
;; test 3 eq_big_int
     (pred_big_int (big_int_of_int (-1)), big_int_of_int (-2))
...
;; test 2 eq_big_int
     (add_big_int zero_big_int (big_int_of_int 1), big_int_of_int 1)

;; test 3 eq_big_int
     (add_big_int (big_int_of_int 1) zero_big_int, big_int_of_int 1)
...
;; test 6 eq_big_int
     (add_big_int (big_int_of_int 1) (big_int_of_int 1), big_int_of_int 2)

;; test 7 eq_big_int
     (add_big_int (big_int_of_int 1) (big_int_of_int 2), big_int_of_int 3)

;; test 8 eq_big_int
     (add_big_int (big_int_of_int 2) (big_int_of_int 1), big_int_of_int 3)

;; test 9 eq_big_int
     ( add_big_int (big_int_of_int (-1)) (big_int_of_int (-1))
     , big_int_of_int (-2) )

;; test 10 eq_big_int
     ( add_big_int (big_int_of_int (-1)) (big_int_of_int (-2))
     , big_int_of_int (-3) )

;; test 11 eq_big_int
     ( add_big_int (big_int_of_int (-2)) (big_int_of_int (-1))
     , big_int_of_int (-3) )

;; test 12 eq_big_int
     (add_big_int (big_int_of_int 1) (big_int_of_int (-1)), zero_big_int)
...
;; test 16 eq_big_int
     (add_big_int (big_int_of_int (-1)) (big_int_of_int 2), big_int_of_int 1)

;; test 17 eq_big_int
     (add_big_int (big_int_of_int 2) (big_int_of_int (-1)), big_int_of_int 1)
...
;; test 2 eq_big_int
     (sub_big_int zero_big_int (big_int_of_int 1), big_int_of_int (-1))

;; test 3 eq_big_int
     (sub_big_int (big_int_of_int 1) zero_big_int, big_int_of_int 1)
...
;; test 6 eq_big_int
     (sub_big_int (big_int_of_int 1) (big_int_of_int 1), zero_big_int)

;; test 7 eq_big_int
     (sub_big_int (big_int_of_int 1) (big_int_of_int 2), big_int_of_int (-1))

;; test 8 eq_big_int
     (sub_big_int (big_int_of_int 2) (big_int_of_int 1), big_int_of_int 1)

;; test 9 eq_big_int
     (sub_big_int (big_int_of_int (-1)) (big_int_of_int (-1)), zero_big_int)

;; test 10 eq_big_int
     ( sub_big_int (big_int_of_int (-1)) (big_int_of_int (-2))
     , big_int_of_int 1 )

;; test 11 eq_big_int
     ( sub_big_int (big_int_of_int (-2)) (big_int_of_int (-1))
     , big_int_of_int (-1) )

;; test 12 eq_big_int
     (sub_big_int (big_int_of_int 1) (big_int_of_int (-1)), big_int_of_int 2)

;; test 13 eq_big_int
     ( sub_big_int (big_int_of_int (-1)) (big_int_of_int 1)
     , big_int_of_int (-2) )

;; test 14 eq_big_int
     (sub_big_int (big_int_of_int 1) (big_int_of_int (-2)), big_int_of_int 3)
...
;; test 17 eq_big_int
     (sub_big_int (big_int_of_int 2) (big_int_of_int (-1)), big_int_of_int 3)
...
;; test 2 eq_big_int
     (mult_int_big_int 1 (big_int_of_int 3), big_int_of_int 3)

;; test 3 eq_big_int (mult_int_big_int 1 zero_big_int, zero_big_int)

;; test 4 eq_big_int
     (mult_int_big_int 2 (big_int_of_int 3), big_int_of_int 6)
...
;; test 2 eq_big_int
     (mult_big_int (big_int_of_int 2) (big_int_of_int 3), big_int_of_int 6)

;; test 3 eq_big_int
     ( mult_big_int (big_int_of_int 2) (big_int_of_int (-3))
     , big_int_of_int (-6) )

;; test 4 eq_big_int
     ( mult_big_int
         (big_int_of_string "12724951")
...
;; let quotient, modulo =
     quomod_big_int (big_int_of_int 1) (big_int_of_int 1)
   in
...
;; let quotient, modulo =
     quomod_big_int (big_int_of_int 3) (big_int_of_int 2)
   in
   test 7 eq_big_int (quotient, big_int_of_int 1)
   && test 8 eq_big_int (modulo, big_int_of_int 1)

;; let quotient, modulo =
     quomod_big_int (big_int_of_int 5) (big_int_of_int 3)
   in
...
;; let quotient, modulo =
     quomod_big_int (big_int_of_int 1) (big_int_of_int 2)
   in
   test 13 eq_big_int (quotient, zero_big_int)
   && test 14 eq_big_int (modulo, big_int_of_int 1)

;; let quotient, modulo =
     quomod_big_int (big_int_of_int (-1)) (big_int_of_int 3)
   in
   test 15 eq_big_int (quotient, minus_big_int unit_big_int)
   && test 16 eq_big_int (modulo, big_int_of_int 2)

;; failwith_test 17
     (quomod_big_int (big_int_of_int 1))
     zero_big_int Division_by_zero

;; let quotient, modulo =
     quomod_big_int (big_int_of_int 10) (big_int_of_int 20)
   in
...
;; test 2 eq_big_int
     (gcd_big_int zero_big_int (big_int_of_int 1), big_int_of_int 1)

;; test 3 eq_big_int
     (gcd_big_int (big_int_of_int 1) zero_big_int, big_int_of_int 1)

;; test 4 eq_big_int
     (gcd_big_int (big_int_of_int 1) (big_int_of_int 2), big_int_of_int 1)

;; test 5 eq_big_int
     (gcd_big_int (big_int_of_int 2) (big_int_of_int 1), big_int_of_int 1)

;; test 6 eq_big_int
     (gcd_big_int (big_int_of_int 1) (big_int_of_int 1), big_int_of_int 1)

;; test 7 eq_big_int
     (gcd_big_int (big_int_of_int 9) (big_int_of_int 16), big_int_of_int 1)

;; test 8 eq_big_int
     (gcd_big_int (big_int_of_int 12) (big_int_of_int 16), big_int_of_int 4)

;; for i = 9 to 28 do
     let n1 = Random.int 1000000000 and n2 = Random.int 100000 in
     let _ =
       test i eq
         ( int_of_big_int
             (gcd_big_int (big_int_of_int n1) (big_int_of_int n2))
         , gcd_int n1 n2 )
     in
     ()
   done
...
;; failwith_test 8
     (fun () ->
       int_of_big_int
         (mult_big_int (big_int_of_int min_int) (big_int_of_int 2)) )
     () (Failure "int_of_big_int")
...
;; test 3 eq
     (is_int_big_int (succ_big_int (big_int_of_int biggest_int)), false)
...
;; test 5 eq
     (is_int_big_int (big_int_of_string (string_of_int biggest_int)), true)

;; test 6 eq
     (is_int_big_int (big_int_of_string (string_of_int least_int)), true)

;; test 7 eq
     (is_int_big_int (big_int_of_string (string_of_int monster_int)), true)
...
;; test 9 eq
     ( is_int_big_int
         (succ_big_int (succ_big_int (big_int_of_int biggest_int)))
     , false )
...
(* test 11 && eq_big_int (bi1, (add_big_int (mult_big_int bi2
   (big_int_of_string "10e0")) (big_int_of_string "20e-1"))) && test 12
   eq_big_int (minus_big_int bi1, (add_big_int (mult_big_int bi2
   (big_int_of_string "-10e0")) (big_int_of_string "-20e-1"))) && test 13
   eq_big_int (bi1, (add_big_int (mult_big_int bi2 (big_int_of_string
   "+10e0")) (big_int_of_string "+20e-1"))) && test 14 eq_big_int
   (minus_big_int bi1, (add_big_int (mult_big_int bi2 (big_int_of_string
   "-10e+0")) (big_int_of_string "-20e-1"))) && test 15 eq_big_int
   (minus_big_int bi1, (add_big_int (mult_big_int bi2 (big_int_of_string
   "-1e+1")) (big_int_of_string "-2e-0"))) && test 16 eq_big_int
   (minus_big_int bi1, (add_big_int (mult_big_int bi2 (big_int_of_string
   "-0.1e+2")) (big_int_of_string "-2.0e-0"))) && test 17 eq_big_int
   (minus_big_int bi1, (add_big_int (mult_big_int bi2 (big_int_of_string
   "-1.000e+1")) (big_int_of_string "-0.02e2")))*)
...
;; test 2 eq_big_int
     (big_int_of_nat (power_base_int 10 8), big_int_of_int 100000000)
...
;; test 1 eq_big_int
     (base_power_big_int 10 0 (big_int_of_int 2), big_int_of_int 2)

;; test 2 eq_big_int
     (base_power_big_int 10 2 (big_int_of_int 2), big_int_of_int 200)

;; test 3 eq_big_int
     (base_power_big_int 10 1 (big_int_of_int 123), big_int_of_int 1230)

;; testing_function "power_int_positive_big_int"

;; test 1 eq_big_int
     (power_int_positive_big_int 2 (big_int_of_int 10), big_int_of_int 1024)
...
;; test 1 eq_big_int
     (power_big_int_positive_int (big_int_of_int 2) 10, big_int_of_int 1024)
...
;; test 4 eq_big_int
     ...
     , big_int_of_string
         ""
     )

;; test 5 eq_big_int
     ( power_big_int_positive_int (big_int_of_string "2197609328765") 243
     , big_int_of_string
         ""
     )
...
;; test 4 eq_big_int
     ( power_big_int_positive_big_int
         (big_int_of_string "200000000000000")
         (big_int_of_int 34)
     , big_int_of_string
         ""
     )
...
;; test 5 eq_big_int
     ( power_big_int_positive_big_int
         (big_int_of_string "2197609328765")
...
;; test 4 eq_int32 (int32_of_big_int (big_int_of_string "-2147"), -2147l)

let should_fail s =
  try
    ignore (int32_of_big_int (big_int_of_string s)) ;
    0
  with Failure _ -> 1
...
;; test 5 eq_big_int (big_int_of_int64 1234L, big_int_of_string "1234")

;; test 6 eq_big_int
     ( big_int_of_int64 0x1234567890ABCDEFL
     , big_int_of_string "1311768467294899695" )

;; test 7 eq_big_int (big_int_of_int64 (-1234L), big_int_of_string "-1234")
...
let should_fail s =
  try
    ignore (int64_of_big_int (big_int_of_string s)) ;
    0
  with Failure _ -> 1
...
let big_int_128 hi lo =
  add_big_int
    (mult_big_int (big_int_of_int64 hi)
...
;; test 2 eq_big_int
     (shift_left_big_int unit_big_int 31, big_int_of_string "2147483648")
...
;; test 6 eq_big_int
     ( shift_right_big_int
         (big_int_of_string "-16570089876543209725755392")
         27
...
;; test 1 eq_big_int
     ( shift_right_towards_zero_big_int
         (big_int_of_string "-5299989648942")
         32
     , big_int_of_int (-1234) )
...
;; test 2 eq_big_int
     (extract_big_int (big_int_128 h1 h2) 67 12, big_int_of_int 1343)

;; test 3 eq_big_int
     ( extract_big_int (big_int_of_string "-1844674407370955178") 37 9
     , big_int_of_int 307 )

;; test 4 eq_big_int (extract_big_int unit_big_int 2048 254, zero_big_int)
...
;; test 6 eq_big_int
     (extract_big_int (big_int_of_int (-1)) 0 16, big_int_of_int 0xFFFF)

;; test 7 eq_big_int
     (extract_big_int (big_int_of_int (-1)) 1027 12, big_int_of_int 0xFFF)

;; test 8 eq_big_int
     (extract_big_int (big_int_of_int (-1234567)) 0 16, big_int_of_int 10617)
...
;; test 10 eq_big_int
     ( extract_big_int
         (pred_big_int (minus_big_int (power_int_positive_int 2 64)))
         64 20
...
;; test 4 eq_int
     (Hashtbl.hash (big_int_of_string "123456789123456789"), 755417385)
