...
class type webSocket =
  object ('self)
    ...
    method onopen :
      ('self Js.t, 'self Dom.event Js.t) Dom.event_listener
      Js.writeonly_prop
    method onclose :
      ('self Js.t, 'self closeEvent Js.t) Dom.event_listener
      Js.writeonly_prop
    method onerror :
      ('self Js.t, 'self Dom.event Js.t) Dom.event_listener
      Js.writeonly_prop
    ...
    method onmessage :
      ('self Js.t, 'self messageEvent Js.t) Dom.event_listener
      Js.writeonly_prop
...
val webSocket_withProtocols :
  (Js.js_string Js.t -> Js.js_string Js.t Js.js_array Js.t -> webSocket Js.t)
  Js.constr
