...
(*let urlencode_js_string_string s = Js.to_bytestring (Js.escape s)*)
...
let encode_arguments l =
  String.concat "&"
    (List.map (fun (n, v) -> urlencode n ^ "=" ^ urlencode v) l)
            ...
            (File
               ...
               ; fu_arguments=
                   decode_arguments_js_string
                     (Js.Optdef.get (Js.array_get res 4) (fun () ->
                          Js.bytestring "" ))
               ; fu_fragment=
                   Js.to_bytestring
                     (Js.Optdef.get (Js.array_get res 6) (fun () ->
                          Js.bytestring "" )) }) ) )
    (fun handle ->
      let res = Js.match_result handle in
      ...
      let url =
        ...
        ; hu_arguments=
            decode_arguments_js_string
              (Js.Optdef.get (Js.array_get res 8) (fun () ->
                   Js.bytestring "" ))
        ; hu_fragment=
            urldecode_js_string_string
              (Js.Optdef.get (Js.array_get res 10) (fun () ->
                   Js.bytestring "" )) }
      in
